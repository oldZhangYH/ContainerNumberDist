    ...
    def crop_save(self) -> None:
        ...
        for img_path in tqdm(all_img_paths):
            ...
            for line in lines:
                ...
                # save to text-line
                text_lines.append(save_img_dir+"/"+f'textbox_{self.save_id}.jpg\t{trans}\n')
...
if __name__ == '__main__':
    basePath="/media/oldzhang/Data&Model&Course/data/ICDAR2015/"
    img_dir = basePath+"train/imgs/"
    gt_dir = basePath+"train/label/"
    save_data_dir =basePath+"cropData/"
